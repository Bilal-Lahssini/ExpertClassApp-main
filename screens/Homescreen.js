...
const Homescreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <Image
        source={require('../assets/img/Luffy.png')}
        style={styles.logo}
      />
      <Text style={styles.title}>Welcome in ChatAPP</Text>
      <Text style={styles.subtitle}>
        Join the discussion of various topics and find schoolmates with the same interests
      </Text>
      <TouchableOpacity
        style={styles.button}
